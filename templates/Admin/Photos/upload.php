...
$this->assign('title', __d('me_cms/photos', 'Upload photos'));
?>
...
<div class="card card-body bg-light border-0 mb-4">
    ...
    <fieldset>
    <?php
    echo $this->Form->label('album', __d('me_cms/photos', 'Album to upload photos'));
    echo $this->Form->control('album', [
        'default' => $this->getRequest()->getQuery('album'),
        'label' => __d('me_cms/photos', 'Album to upload photos'),
